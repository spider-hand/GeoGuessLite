...
import { ChessKnight, ChevronDown, ChevronUp, Menu, X } from '@lucide/vue'
import { ref } from 'vue'
...
const handleGeoChessClick = () => {
  closeMobileMenu()
  window.open(GEOCHESS_URL, '_blank', 'noopener,noreferrer')
}
    ...
    >
      ...
      <div class="navigation-header__actions">
        ...
        <div class="navigation-header__utility-actions navigation-header__utility-actions--desktop">
          ...
          <IconButton
            :ariaLabel="t('components.shared.NavigationHeader.geoChessLink')"
            @click="handleGeoChessClick"
          >
            <ChessKnight :size="18" aria-hidden="true" />
          </IconButton>
        ...
        <div ref="mobileMenuRoot" class="navigation-header__mobile-menu">
          ...
          >
            ...
            <button
              ...
              @click="handleGeoChessClick"
            >
              {{ t('components.shared.NavigationHeader.geoChessLabel') }}
            </button>
